...
while (arreter == 'o')
    ...
    Console.WriteLine();
    Console.WriteLine();
    AffichageCentrale("Faite votre choix");
    Console.WriteLine();
    Console.WriteLine("**************************************************************");
    ...
    if (ch =="1")
            ...
            while (continuer == 'o')
            {
                ...
                switch (preference)
                {
                    ...
                    case 3:
                        ...
                        //Gestion prudente du stock de fleurs apres selection par le client 
                        while (choix != "f")
                        {
                            int choixFleur;
                            if (int.TryParse(choix, out choixFleur) && choixFleur > 0 && choixFleur <= boutique.stockFleur.Count)
                            {
                            ...
                            if (choixFleur > 0 && choixFleur <= boutique.stockFleur.Count)
                            {
                                choixFleurs.Add(boutique.stockFleur[choixFleur - 1]);
        ...
        else
        {
            char continuer = 'o';
            Console.Clear();
            AffichageCentrale("***** BIENVENUE CHER FOURNISSEUR  *****");
            while (continuer == 'o')
            {
                Console.WriteLine();
                Console.WriteLine("Que voulez-vous faire ?");
                Console.WriteLine();
                Console.WriteLine("1. Consulter le stock\n");
                Console.WriteLine("2. Approvisionner\n");
                Console.WriteLine("3. Quitter\n");
                ...
                switch (choix)
                {
                    case "1":
                        Console.WriteLine();
                        Console.WriteLine("**************************************************************");
                        Console.WriteLine("******************   Fleurs Disponible   ********************");
                        Console.WriteLine("**************************************************************");
                        Console.WriteLine();
                        boutique.AfficherStock();
                        Console.WriteLine();
                        Console.WriteLine("**************************************************************");
                        Console.WriteLine();
                        Console.WriteLine($"Quantite disponible: {boutique.stockFleur.Count}");

                        break;

                    case "2":
                        boutique = new MagasinFleur("ZitraafFleurs");
                        Console.WriteLine();
                        Console.WriteLine("Boutique reapprovisionnée avec succes");
                        Console.WriteLine();
                        break;
    ...
    else
    {
        ...
        string email = Console.ReadLine();
        Console.WriteLine("Veuillez entrer le mot de passe en chiffre\n");
        string motDePasse = Console.ReadLine();
        utilisateurs.Add(new Client(1,nom,email,int.Parse(motDePasse)));
